...
{
	const FRealNameStyle& Style =  FModuleManager::GetModuleChecked<FAntiAddictionModule>("AntiAddiction").Style->GetWidgetStyle<FRealNameStyle>("RealNameVietnam");
	...
	OpenBrush = &Style.OpenComboBrush;
	CloseBrush = &Style.CloseComboBrush;
	SavedStyle = &Style;
		...
		[
			...
			[
				...
				+ SVerticalBox::Slot()
				  ...
				  .Padding(Style.ContentTextPadding)
				  // .Padding(54.f, 0.f)
				[
				...
				[
					...
					[
						...
						[
							...
							.ItemStyle(&Style.ComboItemStyle)
							.ComboBoxStyle(&Style.ComboBoxStyle)
				...
				[
					...
					[
						...
						[
							...
							.TextStyle(&Style.SubmitButtonTextStyle)
						]
					]
				]
			]
